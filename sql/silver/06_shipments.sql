...
SELECT 
    ...
    TO_TIMESTAMP(S.DELIVERY_DATE) AS DELIVERY_DATE,
    ...
    CASE 
        WHEN UPPER(TRIM(S.SHIPMENT_STATUS)) = 'DELIVERED' THEN TRUE
        ELSE FALSE
    END AS IS_DELIVERED,
    CASE WHEN S.DELIVERY_DATE IS NULL THEN TRUE ELSE FALSE END AS IS_DELIVERY_DATE_MISSING,
    CASE 
        WHEN S.DELIVERY_DATE IS NOT NULL AND S.SHIPMENT_DATE IS NOT NULL
